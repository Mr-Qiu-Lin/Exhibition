...
?>
    ...
    <div class="w-100 pb-5" style="background: black;">
            <div class="container">
                <div class="row m-0">
                    <div class="col-3 d-none d-md-block text-center" style="background: #ffffe7;border-radius: 0 0 10px 10px">
                        <img  src="images/logo.png">
                    </div>
                    <div class="col-12 col-md-9">
                        <div class="float-right pl-2 pt-2 pr-2 bg-white bor">
                                <?php if($log_name==''){ ?>
                                    <form action="index.php" method="post" style="border-radius: 0 0 10px 10px">
                                        <span>用户名：</span>
                                        <input required type="text" name="name" class="ipt" value="<?=$name?>">
                                        <span>密码：</span>
                                        <input required type="password" name="pwd" class="ipt">
                                        <button type="submit" class="btn btn-sm text-white" style="background:blue;border-radius: 30px">登录</button>
                                        ...
                                        <a href="./admin" class="btn btn-sm text-white" style="background:blue;border-radius: 30px">后台管理</a>
                                    </form>
    ...
    <div class="" style="background: #cacaca;min-height:820px"    >
        <div class="container">
            <div class="row pt-4">
                <?php
       ...
       <div class="d-flex" style="height: 150px">
           <div class="flex-grow-1 pt-3">
              <div class="float-left">
               ...
               <div class="float-left ml-5 d-none d-md-block">
